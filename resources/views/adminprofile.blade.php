                         ...
                         <div class="col-12">
                            ...
                            padding-right: 10px;padding-left: 10px;">
                                      <div  class="col-md-2" style="float:left;padding-left:10px;padding-bottom:20px;">
                                        <div>
                                                  <img src="/profile/{{$admin->img}}"class="" alt="..." id="upfile1" style="cursor:pointer" height="100" width="150" align="right">
                                        </div>
                                      </div>
                                        <div  class="col-md-8">
                                            <div class="form-group">
                                                <input class="" disabled="" placeholder="الاسم" type="text" value="{{$admin->name}}">
                                            </div>
                                        </div>
                                        <div  class="col-md-8">
                                            <div class="form-group">
                                                <input class="" disabled=""  placeholder="الهاتف" type="text" value="{{$admin->phone}}">
                                            </div>
                                        </div>
                                    <div  class="col-md-12">
                                          <button type="button" style=" margin-right:20px;margin-bottom:10px;width:154.67px;" class="btn btn-info" data-toggle="modal" data-target="#exampleModalpassword"> تغير كلمة  المرور </button>
...
<div class="modal fade float-right" id="profileexampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    ...
    <div class="modal-content">
      ...
      <form  id="edit-form" method="POST" action="{{url('/editadminprofile/'.$admin->id)}}" enctype="multipart/form-data">
             @csrf

            <input  name="name" class="form-control" placeholder="الاسم" type="text" value="{{$admin->name}}">
            <br/>
            <input name ="phone" class="form-control" placeholder="الهاتف" type="text" value="{{$admin->phone}}">
            <br/>
      ...
      <div class="modal-footer">
            ...
            <a class="btn btn-standard" href="{{ url('/editadminprofile/'.$admin->id) }}"
...
<div class="modal fade" id="exampleModalpassword" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
          ...
          <div class="modal-body">
          <form action="{{ url('update_admin_password') }}" method="post" id="changpass-form" enctype="multipart/form-data">
                {{csrf_field()}}
          ...
          <div class="modal-footer">
          <button class="btn btn-standard" type="button" data-dismiss="modal">الغاء</button>
          <a class="btn btn-standard" href="{{ url('/update_admin_password') }}"
          onclick="event.preventDefault();
